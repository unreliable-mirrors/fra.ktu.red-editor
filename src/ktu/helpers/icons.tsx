...
export const IconRgb = () => {
  return (
    ...
    >
      <path
        d="m63.332 58.551c7.25-3.9102 12.52-10.871 14.203-19.07-7.9336-2.6289-16.609-1.5664-23.621 2.7734 4.5859 4.3398 7.9141 9.9648 9.418 16.297zm-22.176 1.9375c1.2344-6.0156 4.3984-11.352 8.8438-15.312 4.4453 3.957 7.6094 9.2969 8.8438 15.312-5.7188 1.8945-11.969 1.8945-17.688 0zm-18.691-21.004c1.6836 8.1953 6.9531 15.156 14.203 19.066 1.5-6.3359 4.8281-11.957 9.418-16.297-7.0078-4.3359-15.688-5.3984-23.621-2.7695zm13.418 24.051c-8.9414-4.25-15.598-12.375-17.906-22.117-16.516 8.918-19.887 31.289-6.543 44.633 9.1953 9.1953 23.555 10.91 34.652 4.0391-7.0664-6.6836-11.016-16.289-10.203-26.555zm23.523 1.8086c0.25 8.5938-3.375 16.453-9.4062 21.824-6.0312-5.3711-9.6562-13.227-9.4062-21.824 6.1055 1.8203 12.703 1.8203 18.812 0zm22.613-23.922c8.9336 4.8203 14.777 14.195 14.777 24.754 0 22.074-24.305 35.418-42.887 23.918 7.0664-6.6797 11.012-16.289 10.199-26.551 8.9453-4.2578 15.602-12.383 17.91-22.121zm-50.711-8.1602c-3.2695 0-6.4258 0.47656-9.4062 1.3633-0.45703-15.863 12.258-28.934 28.098-28.934 15.836 0 28.555 13.074 28.098 28.938-9.6328-2.8711-19.98-1.1562-28.098 4.457-5.3086-3.6719-11.75-5.8242-18.691-5.8242z"
        fill-rule="evenodd"
      />
    </svg>
  );
...
export const ICON_DICTIONARY: Record<string, Function> = {
  background_layer: IconBackground,
  draw_layer: IconDraw,
  image_layer: IconImage,
  text_layer: IconText,
  video_layer: IconVideo,
  shape_layer: IconShape,
  rgb_mixin_layer: IconRgb,
};

export const getIcon = (key: string): Element => {
  return ICON_DICTIONARY[key]();
};
